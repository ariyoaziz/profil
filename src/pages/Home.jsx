...
export default function Home() {
    ...
    return (
        <>
            ...
            <section
                className={`min-h-screen flex flex-col items-center justify-center px-4 ${isDarkMode ? "bg-gray-900 text-white" : "bg-gray-100 text-gray-900"} overflow-hidden`} // Pastikan overflow-hidden
            >
                <motion.div
                    className="flex flex-col items-center justify-center pt-20 bg-opacity-50 relative"
                ...
                >
                    ...
                    {/* Animasi roket bergerak dari kiri ke kanan, hanya di dalam Section 2 */}
                    <div className="absolute inset-0 animate-move-horizontal z-0">
                        <img
                            src="/icons/rocket_l.svg" // Ganti dengan path ikon roket Anda
                            alt="Rocket Icon"
                            className="w-16 h-16 sm:w-20 sm:h-20 mx-auto my-auto"
                        />
                    </div>
                    {/* Animasi roket bergerak mengelilingi layar, hanya di dalam Section 2 */}
                    <div className="absolute inset-0 animate-orbit z-0">
                        <img
                            src="/icons/rocket.svg" // Ganti dengan path ikon roket Anda
                            alt="Rocket Icon"
                            className="w-16 h-16 sm:w-20 sm:h-20 mx-auto my-auto"
                        />
                    </div>
            ...
            >
                <div className="text-center">
                    <p className="text-xs sm:text-sm md:text-base lg:text-sm">
                        © 2025 ariyoaziz_. All Rights Reserved.
                    </p>
